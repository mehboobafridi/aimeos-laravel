    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu" class="box">
                ...
                <li>
                    <a href="#a" class="has-arrow waves-effect">
                        <i class="ri-artboard-2-line"></i>
                        <span>@lang('translation.Managment')</span>
                    </a>
                    <ul class="sub-menu " aria-expanded="false">
		    	<li><a href="{{route('gauth')}}" >Google Connection</a></li>

                    </ul>
                </li>

                <li>
                    <a href="#b" class="has-arrow waves-effect">
                        <i class="ri-profile-line"></i>
                        <span>Orders</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
						<li><a href="#" onClick="start_transaction('{{route('download_orders')}}','{{route('view_orders')}}','Downloading Amazon Orders');" >Download Orders</a></li>
						<li><a href="{{route('view_orders')}}" >View Orders</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
						<li><a href="#" onClick="start_transaction('{{route('listings')}}','{{route('view_listings')}}','Downloading Amazon Listings');" >Download Listings</a></li>
						<li><a href="{{route('view_listings')}}" >View Listings</a></li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
						<li><a href="{{route('get_tracking')}}" >Download Trackings</a></li>
						<li><a href="{{route('view_trackings')}}" >View Trackings</a></li>
						<li><a href="{{route('get_trackingMS')}}" >Download Trackings (MSSQL)</a></li>
						<li><a href="{{route('view_trackingsMS')}}" >View Trackings (MSSQL)</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
						<li><a href="{{route('fba_feeMS')}}">Download FBA Fee</a></li>
						<li><a href="{{route('view_fba_feeMS')}}">View FBA Fee</a></li>
						<li><a href="{{route('fba_reimbursementsMS')}}">Download FBA Reimbursements</a></li>
						<li><a href="{{route('view_fba_reimburseMS')}}">View FBA Reimbursements</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
						<li><a  href="{{route('fba_inventory')}}" >Download FBA Inventory</a></li>
						<li><a  href="{{route('fba_inbound')}}" >Download Inbound </a></li>
						<li><a  href="{{route('updateStock')}}"  onclick="return confirm('Are you sure want to update Stock?')"  >Update Stock</a></li>
						<li><a  href="{{route('updatePrice')}}" onclick="return confirm('Are you sure want to update Price?')">Update Price</a></li>
                    </ul>
                </li>
		<li>
                    <a href="javascript: void(0);" class="has-arrow waves-effect">
                        <i class="ri-store-2-line"></i>
                        <span>ShiftShop / 3dcart</span>
                    </a>
                    <ul class="sub-menu" aria-expanded="false">
			<li><a href="{{route('shift_customer_all_load')}}">Download Customers(All)</a></li>

			<li><a href="{{route('shift_customer')}}">Download Customer</a></li>
			<li><a href="{{route('view_shift_customer')}}">View Customer</a></li>
			<li><a href="{{route('shift_order')}}">Download Order (Item)</a></li>
			<li><a href="{{route('view_shift_order')}}">View Order (Item)</a></li>
			<li><a href="{{route('shift_product')}}" >Download Products</a></li>
			<li><a href="{{route('view_shift_product')}}">View Products</a></li>
			<li><a href="{{route('update_shift_product')}}">Update Products</a></li>
                    </ul>
		</li>
              ...
              {{--  <li>
                ...
                {{-- <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{route('login')}} ">@lang('translation.Login')</a></li>
                        <li><a href="{{route('register')}}">@lang('translation.Register')</a></li>
