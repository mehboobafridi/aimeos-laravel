...
<div class="vertical-menu">
    ...
    <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
			...
			<li><a href="{{route('amzAuth')}}" >AMZ Seller Connection</a></li>
			<li><a href="{{route('shift_customer')}}">Download ShiftShop Customers(All)</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
						<li><a href="{{route('orders')}}" >Download Orders</a></li>
						<li><a href="{{route('view_orders')}}" >View Orders</a></li>

						<li><a href="{{route('shift_order')}}">Download ShiftShop Order (Item)</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
						<li><a href="{{route('listings')}}" >Download Listings</a></li>
						<li><a href="{{route('view_listings')}}" >View Listings</a></li>
						
						<li><a href="{{route('shift_product')}}" >Download ShiftShop Products</a></li>
                    </ul>
                </li>
